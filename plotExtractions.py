...
if __name__ == "__main__":
    ...
    for i in enumerate(t1S1data):
        realDelay = i[1]["combinedDelay"] - i[1]["GT"]
        # realDelay = float(i[1]["combinedDelay"]) - float(i[1]["GT"])
        print(f"Combined Delay: {i[1]['combinedDelay']}    RTO: {i[1]['RTO']}     GT: {i[1]['GT']}       Real Delay: {realDelay}")
        # print(i)
